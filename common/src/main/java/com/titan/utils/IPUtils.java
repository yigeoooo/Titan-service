...
public class IPUtils {
	...
	public static String getIpAddr(HttpServletRequest request) {
        ...
        try {
            ...
            if (StringUtils.isEmpty(ip) || MessageConstant.UNKNOWN.equalsIgnoreCase(ip)) {
                ip = request.getHeader("Proxy-Client-IP");
            }
            if (StringUtils.isEmpty(ip) || ip.length() == 0 || MessageConstant.UNKNOWN.equalsIgnoreCase(ip)) {
