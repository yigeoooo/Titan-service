...
//        public static final String THIS_RELATION_ID_NOT_HAVE_MESSAGE_IN_RESERVE_AND_STATEMENT_ITEM = "THIS_RELATION_ID_NOT_HAVE_MESSAGE_IN_RESERVE_AND_STATEMENT_ITEM";
        /*** 當前對帳單分類項id在商戶對帳單分類項目沒有數據,請檢查對帳單分類項id。*/
